<template>
  ...
  <header class="mm-header">
    <h1 class="header"><a  @click="expandWindow()" title="点我全屏">小康在线音乐播放器</a></h1>
    <dl class="user">
    ...
    <mm-dialog ref="loginDialog" headText="登录" confirmBtnText="登录" cancelBtnText="关闭" @confirm="login">
      <div class="mm-dialog-text">
        <input class="mm-dialog-input" type="number" autofocus placeholder="请输入您的网易云UID" v-model.trim="uidValue">
      </div>
    ...
    <mm-dialog ref="helpDialog" headText="登录帮助" confirmBtnText="去登录" cancelBtnText="关闭" @confirm="openDialog(0)">
      <div class="mm-dialog-text">
        <p>1、
          <a target="_blank" href="http://music.163.com">点我(http://music.163.com)</a>打开网易云音乐官网</p>
        <p>2、点击页面右上角的“登录”</p>
        <p>3、点击您的头像，进入我的主页</p>
